...
path = os.getcwd()
pipe = pickle.load(open(f'{path}\\model\\pipe_object.pkl', 'rb'))
df = pickle.load(open(f'{path}\\model\\laptop_data.pkl', 'rb'))
...
if st.button('Predict Price'):
    ...
    # Display the result
    st.title(f"\nPrice: {round(predicted_price * 0.012 * 82.50, 2)} Rupees")

# Note
st.write("""
<span style="color:green">Made by:\n
Raja Chaurasiya   \n
Vikas Yadav</span>
